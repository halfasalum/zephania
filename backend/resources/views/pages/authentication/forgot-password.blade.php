        ...
        <div class="hero-static col-lg-6 col-xl-4">
            <div class="content content-full overflow-hidden">
                ...
                <div class="py-30 text-center">
                    ...
                    <h2 class="h5 font-w400 text-muted mb-0">Enter your email to reset your password</h2>
                </div>
                <!-- END Header -->

                <form action="{{ url('authentication/password/email') }}" method="POST">
                    @csrf
                        ...
                        <div class="block-content">
                            ...
                            <div class="form-group mb-0">
                                <button type="submit" class="btn btn-alt-primary btn-block">
                                    <i class="si si-envelope-open mr-10"></i> Send Password Reset Link
                                </button>
                            </div>
                        </div>
