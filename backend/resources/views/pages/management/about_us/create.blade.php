...
<div class="block">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">About Us Management Form</h3>
...
@csrf
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <div class="col-12">
                                                <label for="mega-firstname">Contents (English)</label>
                                                <textarea type="text" class="form-control form-control-sm"  id="mega-firstname" name="contents_en" placeholder="English title" >{{$whyus->contents_en ?? ''}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <div class="col-12">
                                                <label for="mega-lastname">Contents (Swahili)</label>
                                                <textarea type="text" class="form-control form-control-sm" id="mega-lastname" name="contents_sw" placeholder="Swahii title">{{$whyus->contents_sw ?? ''}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group row">
                                            <div class="col-12">
                                                ...
                                                <input type="text" class="form-control form-control-sm" value="{{$whyus->item1_subheader_en ?? ''}}" id="mega-firstname" name="item1_subheader_en" placeholder="English title">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group row">
                                            <div class="col-12">
                                                ...
                                                <input type="text" class="form-control form-control-sm" value="{{$whyus->item1_subheader_sw ?? ''}}" id="mega-lastname" name="item1_subheader_sw" placeholder="Swahii title">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group row">
                                            <div class="col-12">
                                                ...
                                                <input type="text" class="form-control form-control-sm" value="{{$whyus->item2_subheader_en ?? ''}}" id="mega-firstname" name="item2_subheader_en" placeholder="English title">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group row">
                                            <div class="col-12">
                                                ...
                                                <input type="text" class="form-control form-control-sm" value="{{$whyus->item2_subheader_sw ?? ''}}" id="mega-lastname" name="item2_subheader_sw" placeholder="Swahii title">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            <div class="col-12">
                                                <label for="mega-firstname">Experience</label>
                                                <input type="number" class="form-control form-control-sm" value="{{$whyus->experience ?? ''}}" id="mega-firstname" name="experience" placeholder="English title">
                                            </div>
                                        </div>
                                    </div>
