                        ...
                        <div class="col-6 col-xl-3">
                            <a class="block block-rounded block-bordered block-link-shadow" href="javascript:void(0)">
                                <div class="block-content block-content-full clearfix">
                                    ...
                                    <div class="font-size-sm font-w600 text-uppercase text-muted">All Users</div>
                                </div>
                            </a>
                        </div>
                        <div class="col-6 col-xl-3">
                        ...
                        <div class="col-6 col-xl-3">
                            <a class="block block-rounded block-bordered block-link-shadow" href="javascript:void(0)">
                                <div class="block-content block-content-full clearfix">
                                    ...
                                    <div class="font-size-sm font-w600 text-uppercase text-muted">Inactive Users</div>
                                </div>
                            </a>
                        </div>
</div>
...
<a href="{{ route('users.create') }}">
                                        <button type="button" class="btn btn-sm btn-secondary">Create User <i class="fa fa-user-plus"></i></button>
</a>
                                    </div>
                        </div>
