...
@include('components.header')
    <body>
        ...
        -->
        <div id="page-container" class="sidebar-o side-scroll page-header-fixed page-header-glass page-header-inverse main-content-narrow">
            <!-- Side Overlay-->
                                ...
                                <ul class="nav-users push">
                                    <li>
                                        <a href="be_pages_generic_profile.html">
                                            <img class="img-avatar" src="{{ asset('assets/img/avatars/avatar4.jpg') }}" alt="">
                                    ...
                                    <li>
                                        <a href="be_pages_generic_profile.html">
                                            <img class="img-avatar" src="{{ asset('assets/img/avatars/avatar12.jpg') }}" alt="">
            ...
            <main id="main-container">
                ...
                <!-- Header Section -->
                <div class="bg-image" style="background-image: url('{{ asset('assets/img/photos/photo21@2x.jpg') }}');">
