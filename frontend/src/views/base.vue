    ...
    <main class="main">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12 col-lg-6">
                            <div class="hero-content">
                                <h6 class="hero-sub-title" data-animation="fadeInUp" data-delay=".25s"><i class="fas fa-percent"></i>Award Winning Tax Advisor</h6>
                                <h1 class="hero-title" data-animation="fadeInRight" data-delay=".50s">
                                    We Help You To Avoid Tax Blunders
                                </h1>
                            ...
                            <div class="partner-area pa-1 mt-50">
                                <div class="partner-content">
                                    <h6>Trusted by more than <span>300+</span> companies worldwide</h6>
                                    <div class="row g-0">
                                        <div class="col">
                        ...
                        <div class="col-md-12 col-lg-6">
                            <div class="hero-img-wrap">
                                <div class="hero-img">
                                    <img src="/assets/img/hero/02.jpg" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="service-content">
                                ...
                                <div class="service-info">
                                    ...
                                    <p class="service-text">
                                        There are many variation of the pasage available majority have make
                                        suffered alteration.
                                    </p>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="service-item wow fadeInUp" data-wow-delay=".25s">
                            <div class="service-content">
                                ...
                                <div class="service-info">
                                    <h3 class="service-title">
                                        <a href="service-single.html">Tax Audit Support</a>
                                    </h3>
                                    <p class="service-text">
                                        There are many variation of the pasage available majority have make
                                        suffered alteration.
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="service-item wow fadeInUp" data-wow-delay=".25s">
                            <div class="service-content">
                                ...
                                <div class="service-info">
                                    <h3 class="service-title">
                                        <a href="service-single.html">Tax Advisory</a>
                                    </h3>
                                    <p class="service-text">
                                        There are many variation of the pasage available majority have make
                                        suffered alteration.
        ...
        <div class="video-area2">
            <div class="video-content">
                <div class="video-img py-80" style="background-image: url('/assets/img/video/01.jpg');">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-8">
                                <div class="video-info py-0">
                ...
                <div class="row">
                    <div class="col-md-6 align-self-center">
                        <p class="copyright-text">
                            &copy; Copyright <span id="date"></span> <a href="#"> Taxrio </a> All Rights Reserved.
                        </p>
                    </div>
                    <div class="col-md-6 align-self-center">
